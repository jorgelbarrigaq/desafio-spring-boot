...
public class TareaController {
    ...
    @Operation(summary = "Obtener todas las tareas del usuario autenticado", description = "Devuelve una lista con todas las tareas asociadas al usuario autenticado.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Crear una nueva tarea", description = "Crea una nueva tarea asociada al usuario autenticado.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Actualizar una tarea existente", description = "Actualiza los datos de una tarea del usuario autenticado.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Eliminar una tarea", description = "Elimina una tarea existente del usuario autenticado.")
    @ApiResponses(value = {
